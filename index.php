...
include('log.php')
 ...
 {
	 $kon=mysqli_connect("localhost","root","","forensik");
	 ...
	 debugLog($NamaPengguna.'|'.date('dmYHid').'Mencoba login '.$_SERVER['REMOTE_ADDR'] );
  ...
  <strong>Anda Gagal Login !</strong> Coba Login lagi ya... Jangan Main Hack !.
</div>';
	 }	 
 }
?>
